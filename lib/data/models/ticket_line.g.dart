...
void _ticketLineSerialize(
  ...
  writer.writeDouble(offsets[4], object.totalLine);
}
...
TicketLine _ticketLineDeserialize(
  ...
  object.totalLine = reader.readDouble(offsets[4]);
  return object;
}
...
extension TicketLineQueryFilter
  ...
  QueryBuilder<TicketLine, TicketLine, QAfterFilterCondition> productIdEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<TicketLine, TicketLine, QAfterFilterCondition> productIdLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TicketLine, TicketLine, QAfterFilterCondition> productIdBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
